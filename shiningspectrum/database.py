...
def verification(file_name, data_type, file_data):
    ...
    数据格式可以参考“Prepare incoming data”文件夹
    ...
    #print('数据格式可以参考“Prepare incoming data”文件夹.The data format can refer to the "Prepare incoming data" folder')
...
def import_data(data_path, database_name='raman_database'):
    ...
    GitHub:https://github.com/JunLin615/Shining-Spectrum
